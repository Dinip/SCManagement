...
namespace SeleniumTests
{
    ...
    public class ClubTests
    {
        ...
        public void TheUpdateClubTest()
        {
            ...
            String ClubLocation = driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='myClubTest@scmanagement.me'])[1]/following::span[2]")).Text;
            Assert.AreEqual("Rua Maria Adelaide Rosado Pinto,", driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='myClubTest@scmanagement.me'])[1]/following::span[2]")).Text);
        ...
        public void TheCreateCodeAndUseItTest()
        {
            ...
            driver.FindElement(By.Id("login-submit")).Click();
            driver.FindElement(By.LinkText("Clubes")).Click();
            driver.FindElement(By.LinkText("Juntar-se com código")).Click();
            driver.FindElement(By.Id("Code")).Click();
            driver.FindElement(By.Id("Code")).Clear();
            driver.FindElement(By.Id("Code")).SendKeys(CodeText);
            driver.FindElement(By.XPath("//input[@value='Juntar-se']")).Click();
            driver.FindElement(By.LinkText("Staff")).Click();
            driver.FindElement(By.XPath("//*[@id=\"dropdownMenuButton1\"]/img")).Click();
            driver.FindElement(By.XPath("//ul[@id='Dropdown1']/li[6]/form/div/select")).Click();
            new SelectElement(driver.FindElement(By.XPath("//ul[@id='Dropdown1']/li[6]/form/div/select"))).SelectByText("CreateCodeAndUseIt (Secretaria)");
            driver.FindElement(By.LinkText("Staff")).Click();
        ...
        public void TheCreateTeamTest()
        {
            ...
            driver.FindElement(By.XPath("//input[@value='Juntar-se']")).Click();
            driver.FindElement(By.LinkText("Atletas")).Click();
            driver.FindElement(By.XPath("//*[@id=\"dropdownMenuButton1\"]/img")).Click();
            driver.FindElement(By.XPath("//ul[@id='Dropdown1']/li[6]/form/div/select")).Click();
            new SelectElement(driver.FindElement(By.XPath("//ul[@id='Dropdown1']/li[6]/form/div/select"))).SelectByText("CreateTeam (Atleta)");
            driver.FindElement(By.XPath("//*[@id=\"dropdownMenuButton1\"]/img")).Click();
            driver.FindElement(By.XPath("//ul[@id='Dropdown1']/li[8]/form/button")).Click();
            driver.FindElement(By.LinkText("Iniciar Sessão")).Click();
            driver.FindElement(By.Id("Input_Email")).Click();
