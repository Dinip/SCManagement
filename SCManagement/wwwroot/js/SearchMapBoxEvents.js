...
window.onload = function () {
    ...
    btn.onclick = function () {
        let lblEventId = document.getElementById("lblEventId");
        try {
            if (address != null) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/Events/UpdateLocation',
                    dataType: 'json',
                    data: {
                        eventId: lblEventId.value,
                        address: {
                            CoordinateX: coord[0],
                            CoordinateY: coord[1],
                            ZipCode: addressCode,
                    ...
                    console.log("Sucess")
                        btn.disabled = true;
                        window.location.href = window.location.href = '/Events/Edit/' + lblEventId.value;
